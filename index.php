...
<head>
    <meta charset="utf-8">
    <title><?php session_start(); if(isset($_SESSION['site_name'])) { echo $_SESSION['site_name']; } else {echo "Mehar Grocery";} ?></title>
...
<body>
                ...
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    <div class="row g-4">
                        <?php
                            ...
                            $fetch_products = "SELECT * FROM `products` WHERE `product_status` = 'publish' LIMIT $limit";
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                <?php
                    $fetch_blog_posts = "SELECT * FROM `posts` WHERE `status` = 'publish' LIMIT 3";
