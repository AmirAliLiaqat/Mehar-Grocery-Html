...
<head>
    <meta charset="utf-8">
    <title>About - <?php session_start(); if(isset($_SESSION['site_name'])) { echo $_SESSION['site_name']; } else {echo "Mehar Grocery";} ?></title>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <a class="btn btn-primary rounded-pill py-3 px-5 mt-3" href="contact.php">Contact Us</a>
                </div>
            </div>
        </div>
    </div>
