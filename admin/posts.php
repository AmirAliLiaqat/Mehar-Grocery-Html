...
<head>
    ...
    <title>Posts - Mehar Grocery</title>
            ...
            <div class="main_content">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-01 col-sm-12 admin_content p-3">
                        <h1 class="mb-5">All Posts <a href="add_and_edit_post.php" class="btn btn-primary rounded-pill float-end py-3 px-5">Add New</a></h1>
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="text-lowercase"><?php echo $row['author']; ?></td>
